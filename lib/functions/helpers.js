...
// `req.ip` based on the last untrusted hop. We DO NOT fall back to
...
function getClientIp(req) {
  ...
  // If it's missing, we use a constant bucket so the rate limit still
  // applies — worse UX for legitimate users in that edge case, but closes
  // the bypass.
