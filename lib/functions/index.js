...
// ═══════════════════════════════════════════════════════════════════════════
// Admin Login (rate limited; uses trusted proxy IP only)
// ═══════════════════════════════════════════════════════════════════════════
...
exports.userSendMessage = functions.region('europe-west1').https.onRequest(async (req, res) => {
  ...
  try {
    ...
    // Combined with App Check this makes impersonation much harder: an
    // attacker would need a real device-attested token and a name that
    // someone has actually claimed via the app.
    ...
    // IP alone can punish shared networks too hard.
    const ip = getClientIp(req);
